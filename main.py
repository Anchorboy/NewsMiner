...
if __name__ == "__main__":
    ...
    current_time_end_ts = start_time_ts + window * day_diff
    ...
    while current_time_end_ts < end_time_ts:
        ...
        news_list = news_reader.query_mongoDB_by_time(start_time=current_time_start_t, end_time=current_time_end_t)
        ...
        current_time_start_ts += window * day_diff
        current_time_end_ts += window * day_diff
